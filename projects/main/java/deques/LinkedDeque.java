...
public class LinkedDeque<E> implements Deque<E> {
    ...
    public void addFirst(E element) {
        ...
        Node<E> nodeNew = new Node<> (element, front, front.next);
        front.next.prev = nodeNew;
        front.next = nodeNew;
    }
    ...
    public void addLast(E element) {
        size += 1;
        // TODO: Replace with your code
        Node<E> nodeNew = new Node<> (element, back.prev, back);
        back.prev.next = nodeNew;
        back.prev = nodeNew;
    }
